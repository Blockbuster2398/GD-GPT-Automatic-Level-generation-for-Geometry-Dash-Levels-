class ObjectMap:
    ...
    def __init__(self):
        ...
        self.category_to_id = {
            ...
            "full_block" : [1],
            "full_block_variation_1" : [2, 3, 4, 6, 7, 69, 70, 71, 72, 74, 75, 76, 77, 78, 81, 82, 83, 90, 91, 92, 93, 95, 96, 116, 117, 118, 119, 121, 122, 146, 147, 160, 161, 162, 165, 166, 168, 169, 173, 175, 207, 208, 209, 210, 212, 213, 250, 152, 253, 255, 256, 257, 258, 260, 261, 263, 264, 265, 267, 268, 269, 271, 272, 270, 274, 275, 467, 469, 470, 471, 472, 473, 474],
            # New additions
            "breakable_block" : [143],
