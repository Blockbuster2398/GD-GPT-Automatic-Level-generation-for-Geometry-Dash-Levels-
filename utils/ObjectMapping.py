class ObjectMap:
    ...
    def __init__(self):
        ...
        self.category_to_id = {
            ...
            "full_block" : [1],
            "full_block_variation_1" : [2, 3, 4, 6, 7, 69, 70, 71, 72, 74, 75, 76, 77, 78, 81, 82, 83, 90, 91, 92, 93, 95, 96, 116, 117, 118, 119, 121, 122, 146, 147, 160, 161, 162, 165, 166, 168, 169, 173, 175, 207, 208, 209, 210, 212, 213, 250, 152, 253, 255, 256, 257, 258, 260, 261, 263, 264, 265, 267, 268, 269, 271, 272, 270, 274, 275, 467, 468, 469, 470, 471, 472, 473, 474],
            # New additions
            "breakable_block" : [143],
            "continuous_spikes" : [9, 135, 243, 244, 61, 368, 365, 421, 422, 446, 447, 719],
            "decorative_continuous_spikes" : [18, 19, 20, 21, 20, 49, 48, 114, 113],
            "pulse_deco" : [],
            "gear_deco" : [],
            "pulse_deco" : [54, 53, 52, 51, 50, 60],
            "gear_deco" : [1020, 1000, 1021, 1019, 999, 998, 997, 396, 395, 394, 377, 376, 375, 236, 223, 222, 154, 155, 156, 137, 138, 139, 87, 86, 85, 97],
            ...
            "deco_block" : [5, 73, 80, 94, 120, 121, 143, 164, 193, 211, 233, 251, 259, 279, 273, 280, 281, 282, 325, 358, 479, 478,
                            477, 476, 480, 481, 482, 485, 486, 487, 488, 489, 491, 490, 502, 649, 648, 647, 646, 645, 644, 643,
                            642, 641, 650, 658, 659, 722, 738, 739, 738, 737, 734, 752, 753, 754, 755, 756, 757, 758, 759, 769,
                            766, 765, 764, 877, 808, 809, 810, 811, 812, 813, 814, 815, 816, 817, 818, 819, 820, 821, 822, 823,
                            824, 825, 830, 831, 832, 833, 848, 847, 846, 845, 844, 843, 842, 841, 869, 868, 867, 870, 871, 872,
                            873, 885, 884, 880, 881, 890, 903, 904, 905, 911, 927, 928, 929, 934, 933, 932, 931, 930, 959, 958,
                            957, 956, 955, 954, 953, 952, 964, 965, 966, 967, 968, 974, 975, 976, 977], # (To 1000)
            # Spikes (dx, dy, flip*)
            "spike" : [8, 144, 149, 177, 216],
            "spike_short" : [61, 39, 178, 205, 217, 265],
        ...
        self.category_to_id_create = {
            ...
            "breakable_block" : 143,
            "continuous_spikes" : 421,
            "decorative_continuous_spikes" : 18,
            "pulse_deco" : 396,
            "gear_deco" : 85,
